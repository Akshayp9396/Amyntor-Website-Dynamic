...
const AdminLayout = () => {
    ...
    return (
        <div className="flex h-screen bg-[#f8fafc] font-sans overflow-hidden">
            ...
            <aside
                className={`flex-shrink-0 bg-white/70 backdrop-blur-lg border-r border-slate-200/60 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.02)] z-20 transition-all duration-300 ease-in-out ${isSidebarOpen ? 'w-[260px]' : 'w-[80px]'
                    }`}
            >
                {/* Logo Area */}
