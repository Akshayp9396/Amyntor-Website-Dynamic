...
/**
 * Code Walkthrough
 * This component renders the Case Studies Section.
 * It utilizes Embla Carousel for a purely manual, physics-based, infinite scrolling track.
 * AutoScroll has been removed as per the user's request for manual drag only.
 * UI enhancements include a professional 'Our Expertise' style badge and glassmorphism hover overlays.
 */
...
const mockCaseStudies = [
    ...
    {
        id: 3,
        title: " Configuration of Enterprise Network and Wi-Fi Infrastructure for Genpro Research",
        tags: ["Network Configuration"],
        image: case3
    },
    {
        id: 4,
        title: "Core Switch Replacement and Access Switch Addition for Acsia Technologies",
        tags: ["Network Configuration"],
        image: case4
    },
    {
        id: 5,
        title: "Industrial-Standard Configuration for Bare Metal Hypervisor, Active Directory, Log Server, and Synology NAS Backup at Sentient Scripts",
        tags: ["Sever Configuration"],
        image: case1
    },
    {
        id: 6,
        title: "Industrial-Standard Configuration for Bare Metal Hypervisor, HMS VMs, and NAS Backup at Karakonam Medical College",
        tags: ["Sever Configuration"],
        image: case2
    },
    {
        id: 7,
        title: "Industrial-Standard Configuration for RAID, File Server, and Checkpoint Firewall with VLANs at CMD Trivandrum",
        tags: ["Sever Configuration"],
        image: case3
    }
];
...
const CaseStudySection = () => {
    // ---- EMBLA LOGIC INITIALIZATION ----
    // 'loop: true' allows infinite scrolling.
    // 'dragFree: true' enables natural momentum physics when swiping/dragging.
    // Autoplay has been completely removed.
    ...
    return (
        <section className="py-20 bg-[#F8FAFC] overflow-hidden">
            <div className="max-w-[1400px] mx-auto px-4 md:px-8 mb-8 flex items-center justify-between">
                {/* Updated "Our Expertise" style badge layout */}
                ...
                <div className="embla__container flex touch-pan-y pt-4">
                    {mockCaseStudies.map((study) => (
                        <div key={study.id} className="embla__slide flex-[0_0_85%] sm:flex-[0_0_45%] lg:flex-[0_0_28%] min-w-0 px-4">
                            ...
                            <Link to="/case-study" className="block h-full w-full">
                                <motion.article
                                    whileHover="hover"
                                ...
                                >
                                    {/* Static Background Image with Zoom Hover */}
                                    <motion.img
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 p-8 flex flex-col justify-end z-10 transition-opacity duration-300 group-hover:opacity-0">
                                        ...
                                        <h3 className="text-white font-bold text-l leading-tight">
                                            {study.title}
                                        </h3>
                                    </div>

                                    {/* Hover Glassmorphism 'View Case Study' Overlay replacing solid blue */}
                                    <motion.div
