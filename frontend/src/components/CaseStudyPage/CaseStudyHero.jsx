...
/**
 * Code Walkthrough
 * This component renders the Hero section of the Case Study page.
 * It strictly follows the architectural layout of the AboutHero and ServiceHero components,
 * ensuring absolute visual consistency across the entire platform.
            ...
            <div className="relative w-full h-[50vh] min-h-[380px] max-h-[500px] rounded-[2rem] md:rounded-[2.5rem] flex flex-col items-center justify-center bg-[#050B14] overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        ...
                        className="w-full h-full object-cover object-[center_65%] opacity-[0.35]"
                    />
                    {/* Deep gradient overlays matching project standard vibe */}
