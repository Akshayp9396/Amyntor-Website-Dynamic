            ...
            <div className="space-y-8 flex-grow">
                ...
                <div className="flex items-start gap-5 group pt-2">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 text-[14px] leading-tight opacity-80 whitespace-pre-line">{info.phone.hours}</p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-5 group pt-2">
                    ...
                    <div>
                        ...
                        <a href={`https://wa.me/${info.whatsapp.number.replace('+', '')}`} target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-brand-primary transition-colors text-[15px] block mb-0.5">
                            {info.whatsapp.number} ({info.whatsapp.label})
                        </a>
                    </div>
                </div>
